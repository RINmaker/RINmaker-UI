...
export function parseXmlBonds(text) {
    ...
    nodesRIN = [];
    linksRIN = [];
    res_count = new Array(20) //grandezza fissa poichè non ci sono più di 20 residue
    bond_count = new Array(7) //idem per i legami
    avg_e_bond = new Array(7)
    avg_dist_bond = new Array(7)
    map = {}
    hbond_ext_count = new Array(4)
